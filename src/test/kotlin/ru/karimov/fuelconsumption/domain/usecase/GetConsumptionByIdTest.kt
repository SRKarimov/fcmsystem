...
class GetConsumptionByIdTest {
    ...
    fun `get consumption by id success`() {
        ...
        addUseCase.execute(Consumption(UUID.fromString("ed18a710-6f3c-404e-bba6-fc4276f32ab4"), FuelType.RON92, 1.45, 11.0, LocalDate.now(), Driver(12348L)))
        addUseCase.execute(Consumption(UUID.fromString("ed18a710-6f3c-404e-bba6-fc4276f32ab5"), FuelType.RON92, 1.45, 11.0, LocalDate.now(), Driver(12349L)))

        val res = getByIdUseCase.execute(UUID.fromString("ed18a710-6f3c-404e-bba6-fc4276f32ab3"))
        Assertions.assertNotNull(res)
        Assertions.assertEquals(12347L, res.driver.id)
    }
